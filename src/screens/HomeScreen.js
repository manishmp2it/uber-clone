    ...
    <View style={styles.container}>
      ...
      <ScrollView bounces={false} style={{ height: 300 }}>
        <View style={styles.home}>
          ...
          <View style={styles.view1}>
            <View style={styles.view8}>
              <Text style={styles.text2}>Read a book Take a nap store out window</Text>
        ...
        <View style={styles.view5}>
          ...
          <View>
            <Icon type='material-community' name='chevron-right' color={colors.grey} size={22} />
          </View>
        </View>
          ...
          >
            {carsAround.map((item, index) =>    
                  <MapView.Marker coordinate={item} key={index.toString()}>
                    <Image source={require('../../assets/carMarker.png')}  resizeMode='cover' />
                  </MapView.Marker>
            )}
          </MapView>
